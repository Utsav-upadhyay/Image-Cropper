window.onload = function () {
  ...
  const atdBtn = document.getElementById("addToDownload");

  atdBtn.addEventListener("click", addToDownload);
  ...
  function downloadMultipleImage() {
    imagesBase64.forEach(function (image, i) {
  ...
  function zipAndDownload() {
    var zip = new JSZip();
    imagesBase64.forEach(function (image, i) {
      zip.file("image" + (i + 1) + ".jpg", image.split("base64,")[1], {
        base64: true,
      });
    });
  ...
  $("#downloadAll").click(function () {
    $.ajax({
      type: "POST",
      url: "myimpact.in/testingImgsProc",
      data: "{ data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD…1jSchh2MkeFK5Anv7fbTv5SKFqOFdOvm764mRVLQgtO8RoP/Z}",
